...
const std::string sig1MCfile   = "SolarBi210.ntuple_oxsx.root";
const std::string sig2MCfile   = "SolarPo210.ntuple_oxsx.root";
const std::string sig1TreeName = "output";
const std::string sig2TreeName = "output";

const std::string dataFile1 = "SolarBi210_r11_s0_p1.ntuple_oxsx.root";
const std::string dataFile2 = "SolarPo210_r11_s0_p3.ntuple_oxsx.root";
